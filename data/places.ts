export const places = [
    { id: "munhyeon-art", name: "문현아트센터", zIndex: 10, mapImage: "/buildings/munhyeon.png", detailImage: "/buildings/munhyeon@2x.png", 
        description: "...", 
    ...
    { id: "haeparangil-info", name: "해파랑길관광안내소", zIndex: 20, mapImage: "/buildings/haeparangil.png", detailImage: "/buildings/haeparangil@2x.png", 
        ...
        top: "66.51%", left: "84.51%" }, // 💡 ID를 haeparangil-info로 통일
    { id: "somak-village", name: "우암동 소막마을 주택", zIndex: 40, mapImage: "/buildings/somak.png", detailImage: "/buildings/somak@2x.png", 
        description: "...", 
        ...
        top: "49.65%", left: "18.33%" },
    { id: "bunpo-sports", name: "분포문화체육센터", zIndex: 40, mapImage: "/buildings/bunpo.png", detailImage: "/buildings/bunpo@2x.png", 
        description: "...", 
        ...
        top: "45.54%", left: "74.38%"},
    { id: "namgu-library", name: "남구도서관", zIndex: 10, mapImage: "/buildings/namgu-library.png", detailImage: "/buildings/namgu-library@2x.png", 
        description: "...", 
        ...
        top: "38.65%", left: "47.78%" },
    { id: "gogossing-job", name: "청년창조발전소", zIndex: 30, mapImage: "/buildings/gogossing.png", detailImage: "/buildings/gogossing@2x.png", 
        description: "...",
        ...
        top: "45.10%", left: "57.78%" },
    { id: "miu-study", name: "미우서재", zIndex: 10, mapImage: "/buildings/miu.png", detailImage: "/buildings/miu@2x.png", 
        description: "...",
        ...
        top: "60.06%", left: "73.61%"}, // 
    { id: "sunflower", name: "해바라기소극장", zIndex: 20, mapImage: "/buildings/sunflower.png", detailImage: "/buildings/sunflower@2x.png", 
        description: "...",
        naverMap:"https://map.naver.com/p/entry/place/1525295969?c=15.00,0,0,2,dh&placePath=%",
        top: "39.90%", left: "61.81%" },
    { id: "garam-arthall", name: "가람아트홀", zIndex: 40, mapImage: "/buildings/garam.png", detailImage: "/buildings/garam@2x.png", 
        description: "...",
        ...
        top: "47.63%", left: "46.04%" },
    { id: "gamman-culture", name: "감만창의문화촌", zIndex: 50, mapImage: "/buildings/gamman.png", detailImage: "/buildings/gamman@2x.png", 
        description: "...",
